...
form.addEventListener("submit", async (e) => {
    ...
    // xhr.open("POST", "/public/catalogue/add", true);
    ...
    // formData.append("book_desc", summaryInput.value);
    ...
    //             // If the book was added successfully, alert the user
    //             showSuccessToast("Success", "You have successfully added a book.");
    ...
    //             });
    //         } else {
    //             showErrorToast("Error", "Something went wrong! Please try again. (" + xhr.status + ")");
    //         }
    //     }
    // }
});